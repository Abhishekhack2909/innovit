# ToolMandi - Tool Rental Marketplace

## Project Structure

This project is now organized into separate frontend and backend directories:

- `frontend/` - React-based client application
- `backend/` - Express.js API server (starter template)
...
A full-stack application for agricultural equipment rental.
