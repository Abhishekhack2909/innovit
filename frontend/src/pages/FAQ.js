              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    You can sell your Farm Equipment by listing it on ToolMandi
                    website or ToolMandi mobile applications.
                  </span>
                </details>
                <details class="mb-4">
                  ...
                  <span className="text-justify">
                    Listing on ToolMandi is quite easy. Just click on the
              ...
              <div class="w-full lg:w-1/2 px-4 py-2">
                <details class="mb-4">
                  ...
                  <span class="px-4 py-2 text-justify">
                    ...
                    providers are open to selling equipment on ToolMandi
                    with a fair deal.
                  </span>
                </details>
                <details class="mb-4">
                  <summary class="font-semibold  bg-gray-200 rounded-md py-2 px-4">
                    I don't have a website, Can I still sell on ToolMandi?
                  </summary>

                  <span class="px-4 py-2 text-justify">
                    You don't need a website to start selling on ToolMandi.
